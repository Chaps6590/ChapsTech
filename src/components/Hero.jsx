  ...
  return (
    <section id="inicio" className="hero">
      ...
      <div className="floating-code code-1">
        <span className="code-kw">const</span> bot = <span className="code-fn">new</span> <span className="code-cl">AIAgent</span>();
      </div>
      <div className="floating-code code-2">
        n8n.<span className="code-fn">workflow</span>( &#123; ai: <span className="code-kw">true</span> &#125; )
      </div>
      <div className="floating-code code-3">
        &#47;&#47; <span className="code-cm">Automatización inteligente</span>
      </div>
