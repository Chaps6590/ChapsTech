        ...
        <div className="hero-grid">
          ...
          <div className="hero-left">
            ...
            <h1 className="hero-title">
              ...
              <span className="gradient-text">soluciones digitales</span><br />
            ...
            <div className="hero-stats">
              ...
              <div className="stat">
                <span className="stat-num gradient-text">N8N</span>
                <span className="stat-label">Automatización</span>
              </div>
              <div className="stat-divider" />
              <div className="stat">
                <span className="stat-num gradient-text">IA</span>
                <span className="stat-label">Integrada</span>
              </div>
            </div>
          </div>

          {/* Right column — robot + floating tags */}
          <div className="hero-right">
            <div className="floating-tag tag-1">🌐 Sitios Web</div>
            <div className="floating-tag tag-2">🤖 Asistentes de IA</div>
            <div className="floating-tag tag-3">💬 Chatbots</div>
            <div className="floating-tag tag-4">📞 Call Center</div>
            <div className="floating-tag tag-5">📱 Redes Sociales</div>
